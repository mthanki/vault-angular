...
// Using domino for nom modules to access window etc
const dominoModule = require('domino');
const fsModule = require('fs');
// const indexTemplate = fsModule.readFileSync('dist/browser/index.html').toString();
const indexTemplate = fsModule.readFileSync(join(__dirname, '.', '../index.html')).toString();
...
export function app(): express.Express {
  ...
  const distFolder = join(process.cwd(), 'dist/vault/browser');
